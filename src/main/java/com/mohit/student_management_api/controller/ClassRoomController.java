...
public class ClassRoomController {
	...
	public ResponseEntity<List<StudentResponseDto>> getStudentsByClassRoomId(@PathVariable @Positive(message = "Please enter a valid id") int id) {
		log.info("Request received to get Students for classroomId={}",id);
		List<StudentResponseDto> studentResponseDtos=classRoomService.getStudents(id);
